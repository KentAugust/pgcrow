...
import src
from src.config import CallableScene, Game, GameConfig, Scene2D, WindowConfig
...
gc = GameConfig(title="Game Test", target_fps=60, clean_color=(20, 20, 170))
...
class TestConfigClasses(unittest.TestCase):
    ...
    def test_callablescene_construction(self):
        ...
        self.assertDictEqual({"game": Game}, cs.kwargs)
